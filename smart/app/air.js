    ...
    return (
        ...
        <ScrollView contentContainerStyle={styles.scrollViewContainer}>
          <Card style={styles.image}>
            <Card.Cover source={airImage} style={styles.cardCover} />
          </Card>
          <Text style={styles.heading} variant="titleLarge">Current Air Quality</Text>
          <View style={styles.card}>
            <Meter degree={"PPM"} value={data && data.hasOwnProperty('AirQuality') ? data.AirQuality : 0} />
            <Divider style={styles.matop} />
            <Text style={styles.top} variant="bodyMedium">
              Gain insights into your environment's Air Quality. This card displays the PPM levels along with historical trends. Analyze the data to identify patterns and take proactive measures to maintain a stable and high air quality.
            </Text>
          </View>
          <View style={styles.card}>
            ...
            <View style={styles.controlRow}>
                <Text style={styles.subheading} variant="titleMedium">Auto Air Quality Control </Text>
