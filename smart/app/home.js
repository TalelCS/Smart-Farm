    ...
    return (
        ...
        <ScrollView contentContainerStyle={styles.scrollViewContainer}>
          <Card style={styles.image}>
            <Card.Cover source={tempImage} style={styles.cardCover} />
          </Card>
          <Text style={styles.heading} variant="titleLarge">Current Temperature Levels</Text>
          <View style={styles.card}>
            <Meter degree={"°C"} value={data && data.hasOwnProperty('Temperature') ? data.Temperature : 0} />
            <Divider style={styles.matop} />
            <Text style={styles.top} variant="bodyMedium">
              Stay informed about your environment's temperature. This card shows the current temperature in [°C/°F]. You can also track historical temperature data or set temperature alerts within the app.
            </Text>
          </View>
          <View style={styles.card}>
            ...
            <View style={styles.controlRow}>
                <Text style={styles.subheading} variant="titleMedium">Auto Temperature Control </Text>
                <Switch color={'light'} value={isSwitchOn} onValueChange={setIsSwitchOn} />
            </View>
          </View>
          <View style={styles.actions}>
            <Button icon="check-circle" buttonColor='#008000' textColor='white' onPress={handleSaveConfiguration} mode="elevated" >Save Configuration</Button>
          </View>
        </ScrollView>
      </SafeAreaProvider>
    );
